...
trap 'python3 get_Coordinates.py $mac_device; rm Result/$mac_device/raw_coordinates.txt' SIGINT
adb -s $ANDROID_SERIAL shell getevent -l > Result/$mac_device/raw_coordinates.txt
